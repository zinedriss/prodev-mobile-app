  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView className=" flex-1 p-4">
        <Text className=" text-black  text-4xl font-normal mb-2">Profile</Text>
        <View className=" bg-[#34967C] h-[80px] mb-8 flex-row items-center rounded-md justify-between px-7">
